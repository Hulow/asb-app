...
@injectable()
export class MeasurementQueryResultMapper implements MeasurementQueryResultMapperOutputPort {
  ...
  constructor(params: MeasurementOutputQuery) {
    ...
    this.impedance_equivalence_compliance = params.impedance_equivalence_compliance;
    this.impedance_voice_coil_inductance = params.impedance_voice_coil_inductance;
    ...
    this.impedance_suspension_compliance = params.impedance_suspension_compliance;
  ...
  private _mapDrivers(): Driver[] {
    ...
    for (const driver of drivers) {
      ...
      for (const keyAndValue of keyAndValues) {
        if (keyAndValue.length === 2) d.set(keyAndValue[0].trim(), keyAndValue[1]);
      }
